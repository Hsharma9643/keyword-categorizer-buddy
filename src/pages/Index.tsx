...
const patterns = {
  ...
  // Modified instruction pattern to exclude technical and emotional support queries
  instruction: /(how to(?! (deal|cope) with)|steps|guide|tutorial|process|way to|improve|enhance|boost|increase|optimize|master|learn|tips|advice)(?!.*(anxiety|depression|stress|emotional|mental health|grief|fix|error|bug|issue|technical|specifications?|troubleshoot))/i,
