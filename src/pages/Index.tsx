...
const patterns = {
  ...
  historical: /(tell me about .*(history|past)|history|historical|past|when was|ancient|origin|caused.*war|world war|empire|civilization|century|decade|era|dynasty|period|timeline|heritage)/i,
