...
const Header = () => {
  return (
    <header className="w-full bg-white border-b border-gray-200 py-4 mb-8">
      <div className="container max-w-4xl mx-auto px-4 flex justify-between items-center">
        <div className="flex items-center space-x-2">
          <h2 className="text-xl font-semibold text-[#1A1F2C]">Query Intent Classifier</h2>
        </div>
